...
<section class="content-header">
  <h1>新增商品<!-- <small>Optional description</small> --></h1>
			  ...
			  <form method="post" action="" enctype="multipart/form-data">
				 <div class="box-body">
				 	...
				 	<div class="form-group">
				 		...
				 		<input type="" class="form-control" name="iftitle" id="iftitle" placeholder="请输入商品名称">
				 	</div>
				 		<div class="form-group">
				 		<label><span style="color: red">* </span>价格</label><br>
				 		<input type="" class="form-control"  name="ifprice" id="ifprice" onkeyup="if( ! /^\d*(?:\.\d{0,2})?$/.test(this.value)){alert('只能输入数字，小数点后只能保留两位');this.value='';}" placeholder="只能输入数字，小数点后只能保留两位">
				 	</div>
				 	<div class="form-group">
				 	...
				 	<div class="form-group">
				 		...
				 		<input type="" class="form-control" name="ifintroduce" id="ifintroduce" placeholder="请输入商品简介">
				 	</div>
				 </div>
				 <!-- /.box-body -->
