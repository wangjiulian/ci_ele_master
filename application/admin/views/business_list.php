...
<section class="content">
    ...
    <div class="row">
         ...
         <div class="col-sm-4">
            <a href="/business/add_info"><button style="width: 80px"  class="btn btn-block btn-primary">新增</button></a>
        </div>
    </div>
        ...
        <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
        	...
        	<tbody>
        		...
        		<tr>
        		    ...
        		    <th><a href="/business/edit_info/<?=$lv['id']?>"><button class="btn btn-success btn-sm">编辑</button></a></th>
        		 </tr>
