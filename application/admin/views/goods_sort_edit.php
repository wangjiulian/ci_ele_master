...
<section class="content-header">
  <h1>编辑商品分类<!-- <small>Optional description</small> --></h1>
				 ...
				 <div class="box-body">
				 		...
				 		<select  class="form-control" name='business_id' id="business_id">
				 			<?php foreach ($business as $lv) {?>
				 				<option  <?php if ($target['business_id'] == $lv['id']) {?> selected  <?php }?> value="<?=$lv['id'] . '##' . $lv['name']?>"><?=$lv['name']?></option>
				 		<?php	}?>
				 	...
				 	<div class="form-group">
				 		...
				 		<input value="<?=$target['name']?>" type="" class="form-control" name="iftitle" id="iftitle" placeholder="请输入分类名称">
				 	</div>
				 </div>
				 <!-- /.box-body -->
