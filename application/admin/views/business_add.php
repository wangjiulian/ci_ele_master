			  ...
			  <form method="post" action="" enctype="multipart/form-data">
				 <div class="box-body">
				 	<div class="form-group">
				 		...
				 		<input type="" class="form-control" name="iftitle" id="iftitle" placeholder="请输入商家名">
				 	</div>
				 	<div class="form-group">
				 		<label><span style="color: red">* </span>图片地址</label><br>
				 		<input type="" class="form-control" name="ifimgurl" id="ifimgurl" placeholder="请输入商家背景图">
				 	</div>
				 	<div class="form-group">
				 		<label><span style="color: red">* </span>类别</label><br>
				 		<?php $i = 0;foreach ($sort as $key => $value) {$i++;?>
				 		   <input  type="radio" <?php if ($i == 1) {?> checked <?php }?> value="<?=$key?>" id='sort_type' name="sort_type">&nbsp;&nbsp;<?=$value?></input>&nbsp;&nbsp;
